...
export default function HowToUseSection() {
  return (
    <div className="bg-white w-full">
      <div className="wrapper mx-auto p-4 bg-white">
        {/* Bento layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          {/* Section avec le titre + Section 3 en dessous */}
          <div className="space-y-4">
            <div className="bg-[#121212] p-20 rounded-lg font-extralight text-medium relative shadow-lg">
            ...
            <div className="bg-white p-4 rounded-lg shadow-lg">
              ...
              <ul className="mt-4 px-6">
                ...
                <li className="list-disc text-sm">
                  Pour régler la luminosité des LED, maintenir SELECT + A ou B.
                ...
                <li className="list-disc text-sm">
                  OFF : Les LED sont éteintes. Pour choisir la couleur en
                  STATIC, il faudra les configurer une à une
                </li>
                <li className="list-disc text-sm">
            ...
            <div className="bg-white p-4 rounded-lg shadow-lg">
              ...
              <ul className="mt-4 px-6">
                ...
                <li className="list-disc text-sm">
                  Toucher une fois pour augmenter la luminosité. L’écran possède
          ...
          <div className="space-y-4">
            <div className="bg-[#F8F8F8] p-4 rounded-lg shadow-xl">
              ...
              <p className="mt-4 text-sm px-6">
                La batterie a une capacité de 1800mAh. Il est important
                d’utiliser uniquement le câble de charge fourni avec la console.
                Pour le dock de charge, ne dépassez pas 5 W. Ne pas utiliser de
                Fast Charge. Cela va bloquer la console et la mettre en
                sécurité. (Un SAV sera nécessaire pour la débloquer.) En termes
                d’autonomie, la batterie propose une durée de jeu entre 8 h et
                10 h. Il est également possible de jouer branché.
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-lg">
              <h2 className="font-bold text-lg">
              ...
              <ul className="mt-4 px-6">
                ...
                <li className="list-disc text-sm">
                  DSP : 5 effets de pixel look (Le 1 simule les pixels de
                  l’écran d’origine.)
                </li>
                <li className="list-disc text-sm">
                ...
                <li className="list-disc text-sm">
                  RGB : Permet de choisir une couleur précise via le code
                  couleur
                </li>
                <li className="list-disc text-sm">
